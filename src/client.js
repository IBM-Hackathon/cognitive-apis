...
import { addEventListener, removeEventListener, windowScrollX, windowScrollY } from './core/DOMUtils';
import Provider from './components/Provider';
import { addLocaleData } from 'react-intl';
import configureStore from './flux';
import { setLocale } from './flux/intl';
...
function run() {
  ...
  function onLocationChange(location) {
    ...
    UniversalRouter.resolve(routes, {
      ...
      context,
      render: render.bind(undefined, container, location.state, { // eslint-disable-line
        store
      }),
